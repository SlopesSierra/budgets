...
const BiWeeklyBudget = () => {
  ...
  const [bills, setBills] = useState(() => {
    ...
    return [
      ...
      { id: 5, dueDate: '2025-11-03', name: '🌐 G-Fiber', category: 'Utilities', amount: 71.40, status: 'Pending' },
      { id: 6, dueDate: '2025-11-09', name: '🎬 Crunchyroll', category: 'Entertainment', amount: 12, status: 'Pending' },
      { id: 7, dueDate: '2025-11-13', name: '🚗 Insurance', category: 'Insurance', amount: 253.05, status: 'Pending' },
      { id: 8, dueDate: '2025-11-16', name: '💳 Citi Card', category: 'Credit Card', amount: 70, status: 'Pending' },
      { id: 9, dueDate: '2025-11-21', name: '⚡ Electric', category: 'Utilities', amount: 222, status: 'Pending' },
      { id: 10, dueDate: '2025-11-23', name: '💳 USB Credit Card', category: 'Credit Card', amount: 243, status: 'Pending' },
      { id: 11, dueDate: '2025-11-27', name: '🎵 Spotify', category: 'Entertainment', amount: 21.48, status: 'Pending' },
      { id: 12, dueDate: '2025-11-30', name: '💳 MACU Credit Card', category: 'Credit Card', amount: 150, status: 'Pending' },
    ];
  });
